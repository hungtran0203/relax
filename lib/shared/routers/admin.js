...
import Staff from 'modules/staff/components/ContentContainer';
import StaffContainer from 'modules/staff/components/StaffContainer';
import StaffsMenu from 'modules/staff/components/MenusContainer';
...
export default [
  <Route name='admin' path='/admin' component={Admin}>
    ...
    <Route name='adminStaffs' path='staffs' component={StaffContainer} menu={StaffsMenu}>
      <IndexRoute onEnter={authenticate} />
      <Route name='adminStaff' path=':id' component={Staff} onEnter={authenticate} />
      <Route name='adminStudent' path='student/:id' component={Student} onEnter={authenticate} />
      <Route name='adminCourse' path='course/:id' component={Course} onEnter={authenticate} />
    </Route>
